...
def graph_search(problem, fringe):
    ...
    while fringe:
        node = fringe.pop()
        if problem.goal_test(node.state):
            print("Nodos expandidos: "+str(cuentaNodos))
            return node
...
def search_fring_h(problem):
    """Este metodo ordena con heuristica"""
    return graph_search(problem,hfringe(problem))
